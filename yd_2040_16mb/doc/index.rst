...
YD-2040 Raspberry Pi Pico clone
#################
...
.. figure:: img/yd_2040_16mb.jpg
     :align: center
     :alt: YD-2040 Raspberry Pi Pico clone

     YD-2040 Raspberry Pi Pico clone with 16 MB flash


Supported Features
==================

The yd_2040_16mb board configuration supports the following
hardware features:
